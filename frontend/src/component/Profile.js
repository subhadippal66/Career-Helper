...
function Profile() {
  ...
  return (
    <div>
      <div className="pt-20 w-full h-screen flex flex-row justify-center items-center bg-gray-800">
        <div className="flex md:flex-row flex-col md:w-96 md:h-72 w-72 h-96 bg-gray-300 rounded-2xl">
          <div
